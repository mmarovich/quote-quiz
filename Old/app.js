...
function renderApp(state){
	...
	} else if (state.route === "beginQuiz"){
		renderQuizFirst(state);
...
function answeredQuestion(state){

}

function renderQuizFirst(state){
	...
	$('.question').html(state.questions[state.questionNumber].text);
  	...
  	$('.quiz').submit(function(event){
  		...
  		var checked = $('input[name="choices"]:checked').val();
  		console.log(checked);
  		var correctAnswerNumber = state.questions[state.questionNumber].correctAnswer;
  		if (checked === correctAnswerNumber){
  			$('input[name="choices"]:checked').addClass('right');
  		}
...
function renderQuizPage(state){
  $('.quiz').submit(function(event){
  	...
  	event.preventDefault();
  	if (
  		$('input:checked') === state.questions[state.questionNumber].correctAnswer){
